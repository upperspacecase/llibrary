...
export function reportDataToFacts(data) {
  return {
    ...
    water: {
      ...
      floodBasinStation: wrap(data.water?.floodBasinStation, null, 'floodBasin'),
      floodBasinStations: wrap(data.water?.floodBasinStations, null, 'floodBasin'),
    },
    climate: {
    ...
    economics: {
      ...
      revenueLayers: wrap(data.economics?.revenueLayers, null),
      implicitScenarios: wrap(data.economics?.implicitScenarios, null),
      layerNpv: wrap(data.economics?.layerNpv, null),
...
export function factsToReportData(facts) {
  return {
    ...
    economics: {
      ...
      revenueLayers: unwrap(facts.economics?.revenueLayers) || [],
      implicitScenarios: unwrap(facts.economics?.implicitScenarios) || [],
      layerNpv: unwrap(facts.economics?.layerNpv) || [],
