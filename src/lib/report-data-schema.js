...
const SpeciesSchema = z.object({
  ...
  floraObserved: z.array(TopSpeciesSchema).default([]),
  faunaObserved: z.array(TopSpeciesSchema).default([]),
  floraEndangered: z.array(TopSpeciesSchema).default([]),
  faunaEndangered: z.array(TopSpeciesSchema).default([]),
