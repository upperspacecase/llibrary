export const en = {
  ...
  "create.resetBoundary": "Reset Boundary",
  "create.resetConfirm": "Reset boundary? You'll need to redraw.",
  "create.resetAction": "Reset",
  "create.cancel": "Cancel",
  "create.postcode": "Post code",
  "create.continue": "Continue",
  "create.back": "Back",
  "create.step2Title": "Tell us about your land",
  "create.step2Desc": "Help us understand your land so we can provide better insights.",
  "create.essential": "Essential",
  "create.optional": "Optional",
  "create.email": "Email",
  "create.phone": "Phone (optional)",
  "create.contactPref": "Preferred contact method",
  "create.landArea": "Land area",
  "create.areaHint": "Auto-calculated from your boundary",
  "create.useIntent": "Primary use intent",
  "create.useIntent.conservation": "Conservation",
  "create.useIntent.regeneration": "Regeneration",
  "create.useIntent.mixed": "Mixed-use",
  "create.useIntent.other": "Other",
  "create.waterAccess": "Water access",
  "create.waterYes": "Yes",
  "create.waterSeasonal": "Seasonal",
  "create.waterNo": "No",
  "create.infrastructure": "Existing infrastructure",
  "create.infra.none": "None",
  "create.infra.ruins": "Ruins",
  "create.infra.dwelling": "Dwelling",
  "create.infra.agricultural": "Agricultural buildings",
  "create.vegetation": "Current vegetation",
  "create.veg.degraded": "Degraded",
  "create.veg.mixed": "Mixed",
  "create.veg.woodland": "Established woodland",
  "create.veg.monoculture": "Monoculture",
  "create.successTitle": "Submission received",
  "create.successDesc": "Thank you for sharing your land with us. We'll be in touch soon.",
  ...
  // Landbook v2.0 — Cover & Layout
  "lb.cover.badge": "LANDLIBRARY LANDBOOK V2.0",
  "lb.cover.tagline": "Source of Truth for Land",
  "lb.cover.version": "Version 2.0",
  "lb.cover.hectares": "HECTARES",
  "lb.cover.value": "TOTAL VALUE",
  "lb.cover.bioscore": "BIO SCORE",
  "lb.section.toc": "Contents",
  "lb.section.executive": "Executive Summary",
  "lb.section.risk": "Risk Assessment",
  "lb.section.sources": "Source Citations",
  "lb.exec.keyMetrics": "Key Metrics",
  "lb.exec.propertyDetails": "Property Details",
  "lb.exec.totalArea": "Total Area",
  "lb.exec.perHectare": "Per Hectare",
  "lb.exec.carbonStock": "Carbon Stock",
  "lb.exec.bioScore": "Biodiversity Score",
  "lb.exec.waterSecurity": "Water Security",
  "lb.weather.climateTable": "Monthly Climate Data (30-Year Average)",
  "lb.weather.seasonalPatterns": "Seasonal Patterns",
  "lb.weather.frostAnalysis": "Frost Analysis",
  "lb.bio.speciesByGroup": "Species Distribution by Group",
  "lb.bio.bioindicators": "Bioindicator Status",
  "lb.risk.seasonalCalendar": "Seasonal Risk Calendar",
  "lb.sources.desc": "All data in this report comes from verified open data sources.",
  ...
  "landing.region.modal.success.pending.desc": "We\u2019ll review your suggestion and let you know.",
  "landing.region.modal.title": "Add Your Region",
  "landing.region.modal.vote.title": "Get Notified",
  "landing.region.modal.vote.desc": "Enter your email and we\u2019ll let you know when we launch in this region.",
  "landing.region.modal.suggest.title": "Suggest a Region",
  "landing.region.modal.suggest.desc": "Tell us where you\u2019d like to see LandLibrary. We\u2019ll review your suggestion.",
