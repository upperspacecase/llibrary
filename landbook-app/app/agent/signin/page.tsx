    ...
    <main className="min-h-screen bg-brand-cream">
      <div className="grid min-h-screen grid-cols-1 lg:grid-cols-[1fr_1.15fr]">
        ...
        <div className="flex flex-col px-10 py-12 lg:px-16 lg:py-14">
          <Link href="/agent" className="inline-flex">
            <Image
          ...
          <div className="my-auto max-w-sm py-12">
            ...
            <SerifTitle className="mt-5 text-4xl leading-tight">
              Sign up for a LandBook agent account
            </SerifTitle>
        ...
        <div className="relative hidden overflow-hidden bg-brand-forest lg:block">
          ...
          />
          <div className="relative flex h-full flex-col justify-start p-14 text-brand-cream">
            ...
            >
              Start every listing pitch with a professional LandBook that builds
              trust with sellers and cuts buyer due diligence from weeks to days.
            </p>
          </div>
        </div>
      </div>
